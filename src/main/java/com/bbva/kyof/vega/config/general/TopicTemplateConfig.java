...
public class TopicTemplateConfig implements IConfiguration {
    ...
    @Getter
    private TransportMediaType transportType;
    ...
    @Getter
    private Integer numStreamsPerPort;
    ...
    @Getter
    private String multicastAddressLow;
    ...
    @Getter
    private String multicastAddressHigh;

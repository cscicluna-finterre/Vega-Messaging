...
public class GlobalConfiguration implements IConfiguration {
    ...
    @Getter
    private AeronDriverType driverType;
    ...
    @Getter
    private String embeddedDriverConfigFile;
    ...
    @Getter
    private String externalDriverDir;
    ...
    @Getter
    private ControlRcvConfig controlRcvConfig;
    ...
    @Getter
    private AutoDiscoveryConfig autodiscConfig;

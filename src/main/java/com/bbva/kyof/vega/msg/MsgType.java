...
public final class MsgType {
    ...
    public static String toString(final byte byteValue) {
        switch (byteValue) {
            ...
            case RESP:
                return "RESP";
            case AUTO_DISC_TOPIC:
                return "AUTO_DISC_TOPIC";
            case AUTO_DISC_TOPIC_SOCKET:
                return "AUTO_DISC_TOPIC_SOCKET";
            case AUTO_DISC_INSTANCE:
                return "AUTO_DISC_INSTANCE";
            case AUTO_DISC_DAEMON_CLIENT_INFO:
                return "AUTO_DISC_DAEMON_CLIENT_INFO";
            case HEARTBEAT_REQ:
                return "HEARTBEAT_REQ";
            case CONTROL_SECURITY_REQ:
                return "CONTROL_SECURITY_REQ";
            case CONTROL_SECURITY_RESP:
                return "CONTROL_SECURITY_RESP";
            case ENCRYPTED_DATA:
                return "ENCRYPTED_DATA";
            case CONTROL_SECURITY_ERROR_RESP:
                return "CONTROL_SECURITY_ERROR_RESP";
            case AUTO_DISC_DAEMON_SERVER_INFO:
                return "AUTO_DISC_DAEMON_SERVER_INFO";
            default:
                return "UNKNOWN";
        }
    }
